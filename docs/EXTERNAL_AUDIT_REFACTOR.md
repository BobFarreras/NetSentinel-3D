# Guia de refactor: de ExternalAudit (CLI wrapper) a NativeAudit (Rust nativo)
...
3. mantener `docs/EXTERNAL_AUDIT.md` como legado/transicion.
...
3. extender `ExternalAuditPanel` o crear `NativeAuditPanel`:
...
- `src/ui/components/hud/ExternalAuditPanel.tsx` o `NativeAuditPanel.tsx`
