// src-tauri/src/application/attack_lab/runner.rs
// Runner de Attack Lab: lanza proceso externo, hace streaming de stdout/stderr, soporta timeout y cancelacion cooperativa.
...
use super::sink::AttackLabEventSink;
use super::types::{AttackLabExitEvent, AttackLabLogEvent, AttackLabRequest};
...
pub async fn run_external_tool(
    ...
    sink: Arc<dyn AttackLabEventSink>,
) {
