...
// Catalogo de escenarios del Attack Lab: presets (external), simulaciones (simulated) y escenarios nativos (native) para ejecucion guiada.

import { invoke } from "@tauri-apps/api/core";
import type { AttackLabRequestDTO, DeviceDTO, HostIdentity, WifiNetworkDTO } from "../../../../shared/dtos/NetworkDTOs";
